               ...
               <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="phone_number" placeholder="Your Phone Number" value="{{old('phone_number')}}" >
                    ...
                    <div class="form-group">
                            ...
                            <input class="form-control" type="date" name="date_of_birth" placeholder="" value="{{old('date_of_birth')}}" >
                            @error('date_of_birth') <span class="text-danger error">{{ $message }}</span>@enderror
                        </div>

                        <div class="form-group">
                           <label class="label">Country</label>
                            <input class="form-control" type="text" name="country" placeholder="Your country" value="{{old('country')}}">
                            @error('country') <span class="text-danger error">{{ $message }}</span>@enderror
                        </div>
                   
                        <div class="form-group mt-5">
                            <input type="submit" name="" class="btnContact" value="Submit" />
                        </div>
                        </div>
                    </div>
                </div>
